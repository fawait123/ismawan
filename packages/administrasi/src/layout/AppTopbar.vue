...
const changeCompany = (event: any) => {
    store.changeDefault(event.value)
    ...
    <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            <div class="layout-config-menu">
                <Select v-model="store.default" :options="store.data" option-label="name" @change="changeCompany"
                    option-value="id" placeholder="Select a City" :loading="store.loading" class="w-full md:w-56" />
